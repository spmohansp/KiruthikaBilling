                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form method="post" action="{{ route('admin.AddClients') }}">
                            ...
                            <div class="form-group">
                                <input class="form-control form-control-lg" type="" aria-describedby="emailHelp" name="truck_number" placeholder="Enter Truck Number">
                            </div>
                            <div class="form-group">
                                <input class="form-control form-control-lg" type="" aria-describedby="emailHelp" name="consigment_number" placeholder="Enter Consigment Number">
                            </div>
                            <div class="">
